...
import 'package:jobsque3/02view/screens/08appliedjob/appliedjob2.dart';
...
class JobPreviewCard2 extends StatelessWidget {
  final JobModel? jobModel;
  final VoidCallback? saveOnPressed;
  final String? suffixIcon;

  const JobPreviewCard2({
    Key? key,
    this.jobModel,
    this.saveOnPressed,
    this.suffixIcon,
